...
league = League(league_id=1118513122, year=2023, espn_s2='AEBxvJwo9gYK1pk%2B3S36%2FFZS5WVqYHsY3l6QKMwy538U7Q%2BbCKt237iKEykfAurrxK0T%2B4M%2FhsXk6t2oLyY%2Fle6b5DUKWvsi1ZXzyMRzW7mBevrrtS1Uhyr7KNCPzM0ccOB1Daw4Xv%2FnY9b9KiMxPCRNcosaDEkZfjR%2ByCcF2KtYqhZ90gEfrdWGG4GlVjpMw7Ve4fL7V0mHDp3NgozRqkB7cZH2dZ0fOjF%2BPMwo9hQZ3V3R9jQdvAp2f3Dx2nbDiG%2Fi9oqM9cN1U87DEjHRu7CI', swid='{4656A2AD-A939-460B-96A2-ADA939760B8B}')
scoreboard = league.scoreboard(14)
print(week)
print(scoreboard)
scoreboard = league.scoreboard(15)
print(week)
print(scoreboard)
# print("FINAL STANDINGS")
# print(standings)
# print()
# week14_standings = [team.team_name for team in league.standings_weekly(14)]

# print("REG SEASON STANDINGS")
# print(week14_standings)
# num_playoff_teams = settings.playoff_team_count
# print(num_playoff_teams)
# print()

# num_playoff_teams = settings.playoff_team_count
# print(league.scoreboard(week=15))
# week15_standings = [team.team_name for team in league.standings_weekly(15)]

# print("REG SEASON STANDINGS")
# print(week15_standings)
# print("===")
...
standings = [team.team_name for team in league.standings_weekly(17)]
num_playoff_teams = settings.playoff_team_count
print("FINAL STANDINGS")
print(num_playoff_teams)
print(standings)
