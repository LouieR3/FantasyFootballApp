...
def app():
    ...
    year_options = available_years("The Mike Daisy Sports IQ League")
    if not year_options:
        st.error("No season data found for The Mike Daisy Sports IQ League.")
        return
    ...
    league = f"The Mike Daisy Sports IQ League {selected_year}"
