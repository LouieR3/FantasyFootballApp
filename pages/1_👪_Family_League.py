...
def app():
    ...
    year_options = available_years("Family Fantasy")
    if not year_options:
        st.error("No season data found for Family Fantasy.")
        return
    ...
    # Get correct league ID for the selected year from registry
    league_id = registry.league_id_for("Family Fantasy", year)
