...
function initTimeline() {
	...
	styleEl.textContent = `
		...
		@media (max-width: 1000px) {
			...
			.tile:not(.text-column) .tile__box {
				position: relative;
			}
			.tile-caption {
		...
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					poster:
						"assets/1992.png",
					alt: "Chuck Pennoni in front of a Prime Ware machine",
					title: "Chuck Pennoni in front of a Prime Ware machine",
					depth: 10,
					z: 2
				},
				{
		...
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					poster:
						"assets/1997.png",
					alt: "3001 Market Street at One Drexel Plaza in Philadelphia, PA",
					title: "3001 Market Street at One Drexel Plaza in Philadelphia, PA",
					depth: 5,
					z: 2
				},
				{
				...
				},
				{
					...
					poster:
						"assets/1998.jpg",
					alt: "Map of international Pennoni offices",
					title: "Map of international Pennoni offices",
					depth: 10,
					z: 2
				},
				{
		...
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					alt: "2019 President and CEO, David DeLizza",
					title: "2019 President and CEO, David DeLizza",
					depth: 10,
					z: 2
				}
			]
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					w: "30vw",
					ratio: "16 / 9",
					src: "assets/hurricane-bw.png",
					poster:
						"assets/hurricane-bw.png",
					alt: "Damage of Hurricane Ian in Florida, split into 4 images showing damage to buildings, roads, and vegetation",
					title: "Damage of Hurricane Ian in Florida, split into 4 images showing damage to buildings, roads, and vegetation",
					depth: 10,
					z: 2
				}
			]
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					depth: 10,
					z: 2,
					link: "https://youtu.be/IoSH20VVPeY"
				},
				{
					type: "image",
					...
					poster:
						"assets/Pennoni-Logo.png",
					alt: "Pennoni Logo as of 2023",
					title: "Pennoni Logo as of 2023",
					depth: 10,
					z: 2
				},
			]
		},
		{
			...
			tiles: [
				...
				},
				{
					...
					w: "12rem",
					ratio: "12 / 12",
					src: "assets/Whats-Possible-Logo-White.png",
					poster:
						"assets/Whats-Possible-Logo-White.png",
					alt: "Pennoni What's Possible podcast logo",
					title: "Pennoni What's Possible podcast logo",
					depth: 10,
					z: 2
				},
				{
					...
					alt: "Andrew Pennoni, President and CEO of Pennoni as of 2026",
					title: "Andrew Pennoni, President and CEO of Pennoni as of 2026",
					depth: 10,
					z: 2
				}
			]
	...
	// Expose timelineItems globally so navbar can access it
	window.timelineItems = timelineItems;
	...
	const mountPanels = () => {
		...
		for (const item of timelineItems) {
			...
			panel.id = "year-" + item.id; // Add ID for navbar navigation
