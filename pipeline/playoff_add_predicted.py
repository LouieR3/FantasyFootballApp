...
all_playoffs = pd.read_csv(f"{DATA_DIR}/all_playoff_dfs.csv")
...
all_playoffs.to_csv(f"{DATA_DIR}/all_playoffs_with_predictions.csv", index=False)
print(f"\nUpdated playoffs data saved to f'{DATA_DIR}/all_playoffs_with_predictions.csv'")
