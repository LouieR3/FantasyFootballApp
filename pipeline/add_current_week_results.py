...
try:
    ...
    all_matchups_df = pd.concat([current_matchups, all_matchups_df])
    all_matchups_df = all_matchups_df.drop_duplicates(subset=['League', 'Year', 'Week', 'Home Team', 'Away Team'], keep='last').reset_index(drop=True)
