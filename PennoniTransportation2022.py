def app():
    ...
    st.write('Positive scores indicate winning against tough schedules. Negative scores mean losing with an easy schedule.')
    st.write('Higher scores are better. Scores near zero are neutral.')
