...
import numpy as np
import pandas as pd
from paths import (AGGREGATED_DRAFT_GRADES, DRAFTS_DIR,
                   DRAFT_GRADES_WITH_STANDINGS, MASTER_DRAFT_DATA)

MASTER_CSV = MASTER_DRAFT_DATA
AGGREGATED_CSV = AGGREGATED_DRAFT_GRADES
STANDINGS_CSV = DRAFT_GRADES_WITH_STANDINGS
