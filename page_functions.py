...
def display_remaining_schedule_difficulty(file):
    ...
    columns_to_format = ['Avg_Points_For', 'Avg_Opp_Points_For', 'Avg_Opp_Win_Pct', 'Avg_Opp_LPI']
...
def display_betting_odds_full_width(file):
    ...
    if prob_col in df_first.columns:
        ...
        df_first_styled = df_first_display.style.background_gradient(
            ...
            # subset=[prob_col + '_numeric'],
            subset=[prob_col],
            gmap=df_first_display[prob_col + '_numeric'],  # <-- KEY FIX
            vmin=0,
            vmax=100
        )
    else:
    ...
    if prob_col in df_last.columns:
        ...
        df_last_styled = df_last_display.style.background_gradient(
            ...
            # subset=[prob_col + '_numeric'],
            subset=[prob_col],
            gmap=df_last_display[prob_col + '_numeric'],  # <-- KEY FIX
            vmin=0,
            vmax=100
        )
    else:
