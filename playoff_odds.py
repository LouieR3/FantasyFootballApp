...
# Pennoni Younglings
# league = League(league_id=310334683, year=2024, espn_s2=espn_s2, swid=CRED["louie_swid"])
# league = League(league_id=310334683, year=2023, espn_s2=espn_s2, swid=CRED["louie_swid"])
# league = League(league_id=310334683, year=2022, espn_s2=espn_s2,swid=CRED["louie_swid"])

# Family League
# league = League(league_id=996930954, year=2024, espn_s2=espn_s2, swid=CRED["louie_swid"])
...
# Game of Yards
# league = League(league_id=1781851, year=2024, espn_s2=CRED["prahlad_s2"], swid=CRED["prahlad_swid"])
# league = League(league_id=1781851, year=2022, espn_s2=CRED["prahlad_s2"], swid=CRED["prahlad_swid"])

# Brown Munde
# league = League(league_id=367134149, year=2024, espn_s2=CRED["prahlad_s2"], swid=CRED["prahlad_swid"])

# espn_s2 = CRED["turf_s2"]
# league = League(league_id=1242265374, year=2024, espn_s2=espn_s2, swid=CRED["prahlad_swid"])
